...
A camera motion game for little kids. Runs at https://wiggle-world2.raisedcurious.com

Wave, wiggle, and dance in front of the camera to make six scenes come alive.
...
- `js/scenes.js` - the six scenes
- `js/main.js` - game loop and UI wiring

## Deploy

Push to `main`. Cloudflare Pages (project: wiggle-world2) auto-deploys.
